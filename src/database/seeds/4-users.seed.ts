  ...
  const users = [
    {
      ...
      branch: hqBranch ?? undefined,
      roles: [adminRole].filter((role): role is Role => role !== null),
      preferences: {
        theme: 'light',
        language: 'en',
        notifications: {
    ...
    },
    {
      ...
      status: UserStatus.ACTIVE,
      branch: hqBranch ?? undefined,
      roles: [managerRole].filter((role): role is Role => role !== null),
      preferences: {
        theme: 'dark',
        language: 'en',
        notifications: {
    ...
    },
    {
      ...
      phone: '+1-555-0003',
      status: UserStatus.ACTIVE,
      branch: westsideBranch ?? undefined,
      roles: [cashierRole].filter((role): role is Role => role !== null),
      preferences: {
        theme: 'light',
        language: 'en',
        notifications: {
    ...
    },
    {
      ...
      phone: '+1-555-0004',
      status: UserStatus.ACTIVE,
      branch: hollywoodBranch ?? undefined,
      roles: [cashierRole].filter((role): role is Role => role !== null),
      preferences: {
        theme: 'light',
        language: 'en',
    ...
    },
    {
      ...
      status: UserStatus.ACTIVE,
      branch: hqBranch ?? undefined,
      roles: [inventoryManagerRole].filter((role): role is Role => role !== null),
      preferences: {
        theme: 'dark',
        language: 'en',
        notifications: {
    ...
    },
    {
      ...
      status: UserStatus.ACTIVE,
      branch: westsideBranch ?? undefined,
      roles: [salesAssociateRole].filter((role): role is Role => role !== null),
      preferences: {
        theme: 'light',
        language: 'en',
        notifications: {
    ...
    },
    {
      ...
      status: UserStatus.ACTIVE,
      branch: hqBranch ?? undefined,
      roles: [accountantRole].filter((role): role is Role => role !== null),
      preferences: {
        theme: 'light',
        language: 'en',
        notifications: {
